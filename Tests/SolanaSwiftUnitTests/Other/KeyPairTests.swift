...
struct KeyPairTests {
    ...
    func testRestoreKeyPairFromSecretKey() throws {
        ...
        #expect("QqCCvshxtqMAL2CVALqiJB7uEeE5mjSPsseQdDzsRUo" == account.publicKey.base58EncodedString)
    ...
    func testRestoreKeyPairFromSeedPhrase() async throws {
        ...
        #expect(account12.publicKey.base58EncodedString == "3h1zGmCwsRJnVk5BuRNMLsPaQu1y2aqXqXDWYCgrp5UG")
    ...
    func testRestoreKeyPairFromMnemonic() async throws {
        ...
        #expect(account12.publicKey == "3h1zGmCwsRJnVk5BuRNMLsPaQu1y2aqXqXDWYCgrp5UG")
    ...
    func testRestoreKeyPairFromNonMnemonicSeedPhrase() async throws {
        ...
        #expect(account2.publicKey == "ADBWhBBb8di17PKfdXi4VhQwXnBBiUk8FJBNA6pwUdUc")
        #expect(Base58.encode(account2.secretKey) == "5ruGYGx7Hco9gFoUAHo4nL9Ar7DwJZg9acQVofiYDof6pN8DFcv6vu1ikUbPmEoj7v8RvDGrXrcbDQ4c5jVqqqkC")

        let account3 = try await KeyPair(seed: "Lnj6uTyccG8WETn9", salt: "mnemonic", passphrase: "", network: .mainnetBeta, derivablePath: .default)
        #expect(account3.publicKey == "3mxR3Z2kBkxDJTfYTPcRHbZMeD4CvQTrW8UHvT1FEHd8")
        #expect(Base58.encode(account3.secretKey) == "54oi838sVS7EnEdUgwaf1hLcYxDNZ7HLwrkAAggE9i9rCEPb5hZi9MkEU4r3ReDZ1EGWRpv36zTx7ZeLFZW3E1PL")

        let account4 = try await KeyPair(seed: "HelloWorld", salt: "mnemonic", passphrase: "", network: .mainnetBeta, derivablePath: .default)
        #expect(account4.publicKey == "E6R7yqi3Wh1p7fSrX7bMkSVB9Sh75dAGFgHVFevasSv6")
        #expect(Base58.encode(account4.secretKey) == "YixumKVXM5QwZsKc1k1y3niyWtaH51UxUByVpJMxGswXL6cAp556htJ8rBGPe3m1Q9PiKmtKVgrcMrMATpDZDzJ")
    }
