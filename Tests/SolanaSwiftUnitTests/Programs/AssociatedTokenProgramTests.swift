...
struct AssociatedTokenProgramTests {
    @Test func associatedTokenAddress() throws {
    ...
    @Test func createAssociatedTokenAccountInstruction() throws {
        ...
        #expect(instruction.keys[0] == .writable(publicKey: "3h1zGmCwsRJnVk5BuRNMLsPaQu1y2aqXqXDWYCgrp5UG", isSigner: true))
        ...
        #expect(instruction.keys[3] == .readonly(publicKey: "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v", isSigner: false))
        #expect(instruction.keys[4] == .readonly(publicKey: "11111111111111111111111111111111", isSigner: false))
        #expect(instruction.keys[5] == .readonly(publicKey: "TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA", isSigner: false))
        #expect(instruction.keys[6] == .readonly(publicKey: "SysvarRent111111111111111111111111111111111", isSigner: false))
